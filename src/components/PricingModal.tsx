  ...
  const handleSubscribe = async (plan: "starter" | "ultimate") => {
    try {
      ...
      if (!stripe) {
        ...
        alert("⚠️ Stripe failed to initialize. Please try again.");
        return;
      }
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border flex flex-col">
            ...
            <button
              ...
              className="w-full bg-indigo-600 text-white py-2 mt-4 rounded-lg"
              disabled={loading}
            >
