...
function useComposedRefs3(...refs) {
  return React13.useCallback(composeRefs4(...refs), refs);
}
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React15.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime11.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React15.isValidElement(newElement) ? React15.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var useLayoutEffect23 = (globalThis == null ? void 0 : globalThis.document) ? React25.useLayoutEffect : () => {
};

// node_modules/@radix-ui/react-select/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var React27 = __toESM(require_react(), 1);
var useInsertionEffect = React26[" useInsertionEffect ".trim().toString()] || useLayoutEffect23;
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React30.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime16.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React30.isValidElement(newElement) ? React30.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive4 = NODES4.reduce((primitive, node) => {
  ...
  const Node2 = React31.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot7 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var SelectContentImpl = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst = React33.useCallback(
      (candidates) => {
