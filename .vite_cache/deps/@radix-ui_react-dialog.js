...
var useLayoutEffect22 = (globalThis == null ? void 0 : globalThis.document) ? React6.useLayoutEffect : () => {
};
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime4.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React10.Children.map(children, (child) => (0, import_jsx_runtime4.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime4.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React10.forwardRef(
  (props, forwardedRef) => {
...
var DialogContentModal = React10.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
    const contentRef = React10.useRef(null);
...
var DialogContentNonModal = React10.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
...
var DialogContentImpl = React10.forwardRef(
  (props, forwardedRef) => {
