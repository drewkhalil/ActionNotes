...
var useLayoutEffect2 = (globalThis == null ? void 0 : globalThis.document) ? React14.useLayoutEffect : () => {
};
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React17.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime7.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React17.isValidElement(newElement) ? React17.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable3(child) {
  return React17.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER3;
}
...
function useCallbackRef4(initialValue, callback) {
...
function useMergeRefs(refs, defaultValue) {
  var callbackRef = useCallbackRef4(defaultValue || null, function(newValue) {
...
var useLayoutEffect23 = (globalThis == null ? void 0 : globalThis.document) ? React30.useLayoutEffect : () => {
};
...
//# sourceMappingURL=chunk-R3GP2JNE.js.map
